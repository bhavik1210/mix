  ...
  return (
    <div className='home-container-1'>
        ...
        <div className="home-container-2">
            ...
            <p className='tags-p'>A tag is a keyword or label that categories your question</p>
            <p className='tags-p'>Using the right tags make it easier for others to find ans asnwer your question</p>
