...
//     questionTags:["Java","javascript","html","python","python","React","la","css","node "],
//     userPosted:"mano",
//     userId:1,
//     askedOn: "jan1",
//     answer:[{
...
const url='https://stackoverflow1.onrender.com'
...
const handlePostAns =(e,answerLength)=>{
    e.preventDefault()
    if(User=== null){
        alert('Login or signup to a answer a questio')
        Navigate('/Auth')
